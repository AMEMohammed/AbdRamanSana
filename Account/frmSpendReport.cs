...
namespace Account
{
    public partial class frmSpendReport : Form
    {
        AccountNm Acn;
        int IDUSER;
        ...
        public frmSpendReport(string ServNm, string DbNm, string UesrSql, string PassSql, int UserId)
        {
            InitializeComponent();
            try
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dataGridView1.DataSource = Acn.GetSpendReport(AccountName, CashingName, CurnncyName, totelordetles, d1, d2);
            }
            catch (Exception ex) { MessageBox.Show(ex.Message); }
